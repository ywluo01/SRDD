...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, pool=True,downsample=None, drop_rate=0.0, drop_block=False, block_size=1):
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, stride=1,pool=True, drop_rate=0.0, drop_block=False, block_size=1):
        downsample = None
        ...
        layers = []
        layers.append(block(self.inplanes, planes, stride,pool, downsample, drop_rate, drop_block, block_size))
